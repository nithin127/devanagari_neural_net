# ==============================================================================
# Adapted from https://github.com/tensorflow/tensorflow/blob/r0.11/tensorflow/examples/tutorials/mnist/fully_connected_feed.py
# ==============================================================================
"""Trains and Evaluates the Devanagari network using a feed dictionary."""
...
def run_training():
  ...
  with tf.Graph().as_default():
    ...
    train_op = network_structure.training(loss, FLAGS.learning_rate)

    # Add the Op to compare the logits to the labels during evaluation.
    eval_correct = network_structure.evaluation(logits, labels_placeholder)
